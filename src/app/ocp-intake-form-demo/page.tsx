...
const initialForm = {
  date: '2026-09-15',
  requestor_name: 'Jordan Blake',
  department: 'Brand Protection',
  client_status: 'New',
  client_name: 'Acme Streaming Co.',
  third_party: '',
  cost_proposal: 'Yes',
...
export default function OcpIntakeFormDemoPage() {
  ...
  function generatePDF() {
    ...
    pdfDoc.save(`${stamp}_OCP_Intake_DEMO_${client}.pdf`);
    clearDraft();
  }
    ...
    <>
      ...
      <div className="intake-page">
        <header className="app-bar">
          ...
          <div className="meta">OCP INTAKE FORM · DEMO</div>
        </header>

        <main className="page">
          <div className="form-head">
            <div className="eyebrow">INTAKE &gt; SCOPING &gt; ESTIMATE &gt; KICKOFF</div>
            <h1>OCP Intake Form <span className="demo-tag">DEMO</span></h1>
            <div className="sub">
              This is a pre-filled example with sample data for preview purposes only — nothing here is a real client submission. The blank form for real requests is at <a href="/ocp-intake-form">/ocp-intake-form</a>.
            </div>
          ...
          <form id="ocpIntakeFormDemo" noValidate>
          ...
          <div className="form-footer">
            <div className="conf">IP House — Confidential &amp; Proprietary · Demo Data</div>
